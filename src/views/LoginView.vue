...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="bg-white  rounded-xl lg:w-1/3  md:w-[60%] w-full p-10 mt-8 shadow-xl">
                    <p tabindex="0" class="focus:outline-none text-xl font-extrabold leading-6 text-gray-800">Login to your account</p>
                    <p tabindex="0" class="focus:outline-none text-xs mt-4 font-medium leading-none text-gray-500">Dont have account? <a href="/register"   class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Sign up here</a></p>
...
import { handleLogin } from '@/api/authentication_api'
import { ref } from 'vue';
