<template>
    <div class="h-full  w-full py-8 px-4 bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-accent to-white">
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
            <div class="flex flex-col items-center justify-center">
                <!--  LOGO  -->
                <div class="text-black text-[50px] font-sans font-bold">CITELY.AI</div>

                <div class="bg-white  rounded-xl lg:w-1/3  md:w-[60%] w-full p-10 mt-8 shadow-xl">
                    <p tabindex="0" class="focus:outline-none text-xl font-extrabold leading-6 text-gray-800">Register an account</p>
                    <p tabindex="0" class="focus:outline-none text-xs mt-4 font-medium leading-none text-gray-500">Already have an account? <a href="/"   class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Login here</a></p>
                    <button aria-label="Continue with google" role="button" class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-8">
                    ...
                    <button aria-label="Continue with github" role="button" class="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p class="text-sm font-medium ml-4 text-gray-700">Continue with Github</p>
                    </button>
                    <button aria-label="Continue with twitter" role="button" class="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-2.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p class="text-sm font-medium ml-4 text-gray-700">Continue with Twitter</p>
                    </button>
                    <div class="w-full flex items-center justify-between py-4">
                        ...
                        <div>
                            ...
                            <input v-model="credentials.email" aria-labelledby="email" type="text" class="bg-gray-100 border rounded  text-xs font-medium leading-none text-gray-800 py-2.5 w-full pl-3 mt-2"/>
                        </div>
                        <div class="mt-4  w-full">
                           ...
                           <div class="relative flex items-center justify-center">
                            <input v-model="credentials.password" id="pass" type="password" class="bg-gray-100 border rounded  text-xs font-medium leading-none text-gray-800 py-2.5 w-full pl-3 mt-2"/>
                        ...
                        <div class="mt-8">
                            <button @click="login()" role="button" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-black focus:outline-none bg-accent border rounded-md hover:bg-accent-300 py-3 w-full">Login</button>
                        </div>
                </div>
            </div>
        </div>
...
import { handleSignup } from '@/api/authentication_api';
import { ref } from 'vue';
...
const login = () => {
    ...
    handleSignup(credentials.value)
    // .then((data) => {
    //     console.log(`Registered successfully in`, data)
